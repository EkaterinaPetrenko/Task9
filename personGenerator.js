const personGenerator = {
    ...
    profFemaleJson: `{  
        ...
        "list": {
            "id_1": "веб-разработчик",
            "id_2": "хирург",
            "id_3": "учитель начальных классов",
            "id_4": "маляр",
            "id_5": "воспитатель",
            "id_6": "инженер",
            "id_7": "парикмахер",
    ...
    /* В зависимости от сгенерированного пола функция возвращает случайное мужское или женское имя */
    ...
    /* Функция возвращает случайную фамилию; если пол женский, прибавляет к фамилии "а" */
    ...
    /* Функция возвращает случайное отчество; если пол женский, меняет окончание отчества с "ич" на "на" */
    ...
    /* В зависимости от сгенерированного пола функция возвращает случайную мужскую или женскую профессию */
    randomProfession: function() {
        return this.person.gender === this.GENDER_MALE ? this.randomValue(this.profMaleJson) : this.randomValue(this.profFemaleJson);
    },

    /* Функция формирует случайную дату рождения */
    randomBirthDate: function() {
        let curDate = new Date();
        /* Год берется из временного промежутка на 100 лет назад от текущего года*/
        let birthYear = this.randomIntNumber(curDate.getFullYear(), curDate.getFullYear() - 100);
        let textDate = ` ` + birthYear.toString() + ` года рождения`;
        /* Генерируем месяц и определяем соответствующее максимальное количество дней */
        ...
        switch (birthMonth) {
            ...
            case 2:
                ...
                /* Учитываем високосные года для февраля */
